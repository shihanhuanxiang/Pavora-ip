...
const FACE_ARCHETYPE_MAP: Record<string, Record<string, string>> = {
    female: {
        ...
        taiwan_natural: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: soft oval with gentle taper toward chin, natural cheek volume without excessive baby fat, jaw is smooth and lightly defined giving photogenic lift. NOT round or flat — the face has upward structural energy. EYES: natural double eyelids with clearly visible crease, eyes appear bright and larger than average due to clear defined lid line and luminous iris, eye tails neutral to very slightly upturned giving alert camera-aware energy, mild aegyo-sal under-eye fat pad adding warmth. INDIVIDUALITY: slightly asymmetric eye openings, lips have natural soft color with gentle cupid's bow definition, subtle visible pores on nose bridge. SKIN: luminous translucent quality, inner-glow effect on cheekbones, NOT matte or dull. OVERALL: feature proportions well-balanced within the ranges above - inter-eye distance close to one eye-width, mouth width slightly narrower than the inter-pupillary distance, a clearly defined lid line and a bright iris catchlight in both eyes.",
        taiwan_sweet: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: round face with prominent baby-fat cheeks, short chin, heart-shaped upper face. EYES: crescent-shaped double eyelids that curve into eye-smile naturally, large bright irises, strong aegyo-sal under-eye pouch. INDIVIDUALITY: one side of mouth corners slightly higher when relaxed giving natural gentle smile, small visible nose tip rounding, skin has natural slight unevenness NOT airbrushed. Youthful sweet energy with real-girl imperfections.",
        korean_iu: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: soft inverted triangle, V-line jaw that is soft not sharp, high-set cheekbones but not prominent, forehead slightly wide. EYES: refined almond double eyelids, strong aegyo-sal under-eye fat pad (signature IU feature), inner corner slightly pointed, gaze has soft deer-eyed quality. INDIVIDUALITY: subtle natural asymmetry in eye tail angles, lips naturally slightly pouty at center with defined cupid's bow, philtrum slightly long giving mature-sweet balance. NOT aggressively cute, gentle refined sweetness.",
        japanese_pure: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: slim narrow oval, delicate bone structure, slightly angular but soft jaw, understated features that don't shout. EYES: single or natural inner-double eyelids (NOT full crescent double), almond shape, gaze is calm and quietly expressive, lashes natural not dramatic. INDIVIDUALITY: nose bridge is low-to-medium (NOT high European), slight natural asymmetry in upper lip shape, skin has porcelain quality but with subtle natural texture NOT plastic. Quiet understated beauty that grows on you, NOT immediately striking.",
        mature_elegant: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: defined oval with visible but not sharp cheekbone structure, jaw is clean and tapered, forehead balanced. EYES: mature double eyelids with more visible lid space, gaze is direct and composed, slight natural hood to upper lid giving depth. INDIVIDUALITY: faint natural eye corners (NOT crow's feet, but lived-in depth), defined philtrum, lips have natural pigment variation (slightly darker at corners), skin shows very subtle texture of a real adult woman NOT teenager-smooth. Confidence without trying.",
        mixed_aesthetic: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: three-dimensional structure, higher and more defined cheekbones than typical East Asian, slightly stronger jaw but still feminine, face has more sculptural quality. EYES: deep-set double eyelids, larger iris diameter than typical Asian, slight natural shadow in upper orbital area giving depth, eye color may be naturally lighter brown. INDIVIDUALITY: nose bridge visibly higher with defined bridge line (NOT European sharp, but clearly elevated), fuller lips with natural color variation, skin has warm honey-toned unevenness (NOT matte uniform). East Asian proportions but with three-dimensional dimensionality.",
    ...
    male: {
        ...
        taiwan_boy_next_door: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: slightly rounded square face, defined but not aggressive jaw, cheeks have slight natural fullness. EYES: gentle double or natural single eyelids, warm soft gaze, eye tail neutral or very slightly downturned. INDIVIDUALITY: slight natural smile lines starting at mouth corners, visible skin pores on nose and T-zone, eyebrows slightly irregular NOT perfectly groomed. Real adult masculine texture, NOT a polished idol.",
        korean_idol_male: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: V-line jaw that is sharp but not aggressive, high and slightly prominent cheekbones, smooth skin, face reads as aesthetically refined. EYES: defined crease double eyelids, dark iris, gaze is calm and slightly intense, natural lash density. INDIVIDUALITY: cupid's bow lips with natural slight pout, philtrum well-defined, skin is smooth but NOT plastic — subtle texture under eyes and at nose. Polished but real, NOT CGI.",
        japanese_fresh_male: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: slim narrow oval, delicate but masculine bone structure, jaw is clean and slightly tapered. EYES: natural single or soft-double eyelids, calm expressive gaze, eyebrows natural and slightly sparse. INDIVIDUALITY: nose is refined with slightly low bridge (Japanese typical), lips thin to medium with natural pale color, skin has clean matte quality with slight natural texture. Understated masculine freshness.",
        mature_taiwan_male: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: defined strong jaw with slight squareness, cheekbones defined, face reads experienced not soft. EYES: deeper set with visible slight upper lid heaviness, gaze is direct and composed, slight natural squint from confidence. INDIVIDUALITY: very faint beginning of laugh lines at eye corners (NOT wrinkles, just depth), defined philtrum, skin shows real adult male texture (NOT teenager-smooth), optional very faint stubble shadow. Real mature masculine energy.",
        mixed_aesthetic: "ETHNICITY: East Asian (Taiwanese) facial bone structure - cheekbones low-profile with minimal forward projection, nasal root starting at eye level with low-to-moderate height, dorsum straight and narrow, alar base narrow, orbital rims shallow with no upper-socket shadow, soft gonial angle. This bone structure overrides all styling, hair colour and skin tone directives below. FACE SHAPE: three-dimensional bone structure, defined and slightly prominent cheekbones, jaw is strong and angular but still proportional. EYES: deep-set with natural orbital shadow, larger iris with lighter brown tone possible, direct intense gaze. INDIVIDUALITY: nose bridge clearly elevated (NOT European extreme, but dimensional), lips fuller than typical East Asian male, skin warm honey-tone with natural variation. Striking dimensional face.",
...
export const buildModelPrompt = (params: any) => {
    ...
    if (!params.faceReferences || params.faceReferences.length === 0) {
        ...
        prompt += `- BEAUTY FLOOR (APPLIES TO BOTH GENDERS AND ALL ARCHETYPES): This model is the face of a commercial fashion & social-media IP account. Feature proportions must read as well-balanced and stay within these ranges: inter-eye distance 0.9 to 1.1 eye-widths, mouth width slightly narrower than the inter-pupillary distance, nose length about one-third of face height, a clearly defined lid line and a bright iris catchlight in both eyes, even skin tone with visible pores but no roughness, no under-eye darkness and no nasolabial shadow at rest. Realism details (pores, subtle asymmetry) must stay subtle and must NEVER make the face look plain, tired, or aged.\n`;
