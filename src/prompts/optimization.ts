...
請以 JSON 格式回傳。critique_zh 的內容必須使用繁體中文 (Traditional Chinese)；suggested_params.additional_prompt MUST be written in English (it is inserted directly into an English image-generation prompt)：
{ 
  ...
  "suggested_params": { 
    ...
    "additional_prompt": "additional optimization prompt in English, e.g. enhance golden-hour rim lighting on the subject"
  } 
}
