...
const ImageDeconstructionStudio: React.FC<ImageDeconstructionStudioProps> = ({ onGoBack, onGoHome }) => {
    ...
    const handleSaveAssets = () => {
        ...
        const newItems: StoredApparelItem[] = assetResult.assets.map(asset => ({ id: `apparel-${Date.now()}-${Math.random()}`, name: asset.name, imageUrl: asset.pngTransparentUrl, category: 'extracted' }));
